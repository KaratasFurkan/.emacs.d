...
(use-package olivetti
  :defer nil
  :init
  (defvar fk/olivetti-fringe-face `(:background ,fk/dark-color2))
...
;;    )
;;   :config
;;   ;; TODO: this is not work anymore, write your own smart-jump
...
(use-package lsp-pyright
  ...
  :config
  (let ((process (start-process "pyright-updates" nil
                                "bash" "-c" "npm outdated -g | grep pyright | wc -l"))
