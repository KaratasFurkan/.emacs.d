...
(use-package doom-themes
  ...
  (highlight ((t (:underline t :weight semi-bold :background nil :foreground nil))))
...
(use-package symbol-overlay
  ...
  :hook
  (python-mode . (lambda () (symbol-overlay-mode -1)))  ; i use lsp highlight
...
(use-package lsp-mode
  ...
  :custom-face
  (lsp-face-highlight-read ((t (:underline t :weight semi-bold :background nil :foreground nil))))
  (lsp-face-highlight-write ((t (:underline t :weight semi-bold :background nil :foreground nil))))
  (lsp-face-highlight-textual ((t (:underline t :weight semi-bold :background nil :foreground nil))))
  :hook
...
(use-package smerge-mode
  ...
  (defhydra smerge-hydra
    (
     :color red
     :hint nil
     :pre (setq-local global-hl-line-mode nil)
