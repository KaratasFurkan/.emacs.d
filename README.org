...
(fk/helm-rg-define-search-command
 "fk/django-search-models" django "m" "models.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-views" django "v" "views*.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-serializers" django "s" "*serializers*.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-tests" django "t" "*test*.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-settings" django "S" "*/settings/*" "")

(fk/helm-rg-define-search-command
 "fk/django-search-admins" django "a" "admin.py" "^class admin( ")

(fk/helm-rg-define-search-command
 "fk/django-search-permissions" django "p" "permissions.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-mixins" django "x" "mixins.py" "^class ")

(fk/helm-rg-define-search-command
 "fk/django-search-urls" django "u" "*.py" "path( ")
