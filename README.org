...
(use-package deadgrep
  ...
  :hook
  (deadgrep-mode . (lambda () (setq-local show-trailing-whitespace nil))))
#+END_SRC
...
"
    ...
    ("P" org-priority-down)
    ;; Todo
    ("w" (lambda () (fk/org-refile-fixed-location "todos.org" "Work")))
    ("e" (lambda () (fk/org-refile-fixed-location "todos.org" "Emacs")))
    ("h" (lambda () (fk/org-refile-fixed-location "todos.org" "Home")))
    ("o" (lambda () (fk/org-refile-fixed-location "todos.org" "Other")))
    ;; Someday
    ("E" (lambda () (fk/org-refile-fixed-location "someday.org" "Emacs")))
    ("T" (lambda () (fk/org-refile-fixed-location "someday.org" "Tech")))
    ("M" (lambda () (fk/org-refile-fixed-location "someday.org" "Movie")))
    ("S" (lambda () (fk/org-refile-fixed-location "someday.org" "TV Show")))
    ("A" (lambda () (fk/org-refile-fixed-location "someday.org" "Anime")))
    ("V" (lambda () (fk/org-refile-fixed-location "someday.org" "Video")))
    ("F" (lambda () (fk/org-refile-fixed-location "someday.org" "Food")))
    ("O" (lambda () (fk/org-refile-fixed-location "someday.org" "Other")))
    ;; Archive
