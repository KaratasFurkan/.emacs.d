...
"
  ...
  (add-hook 'org-clock-out-hook (lambda () (setq fk/org-clock-string "")))
  (add-hook 'org-clock-cancel-hook (lambda () (setq fk/org-clock-string "")))
  ...
  (defun fk/org-clock-out-and-update-report (orig-func &rest args)
    ...
    (let ((buffer (org-clocking-buffer)))
      ...
      (with-current-buffer buffer
        (let ((current-prefix-arg 4)) (call-interactively 'org-clock-report)))))
