...
(use-package zoom
  :straight (:host github :repo "KaratasFurkan/zoom" :branch "control-track-mouse-behaviour-with-a-variable")
  :commands zoom-mode
  :custom
  (zoom-track-mouse-preserve-layout nil)
  :preface
...
(use-package org-tree-slide
  :straight (:host github :repo "KaratasFurkan/org-tree-slide" :branch "create-variable-content-margin-top")
...
(use-package password-mode
  ...
  (org-mode . (lambda () (when (stringp buffer-file-name)
