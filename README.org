...
(use-package olivetti
  ...
  (olivetti-excluded-buffer-regexps `(,@olivetti-excluded-buffer-regexps
...
;; Split & Switch
;; (global-set-key (kbd "C-1") 'delete-other-windows)  ; I use `fk/smart-C-x-1',
                                                       ; see Appearance / Olivetti
